...
public static class SRealtyEnumsExtension
{
    ...
    public static string GetLocalizedDisplayName<T>(this T enumValue, string cultureName = "cs-CZ") where T : struct, Enum
    {
    ...
    public static string GetLocalizedDescription<T>(this T enumValue, string cultureName = "cs-CZ") where T : struct, Enum
    {
        return cultureName.StartsWith("cs", StringComparison.OrdinalIgnoreCase) 
