...
public sealed class SRealtyHandlers: ICrudService<SRealityAdvertDto,SRealtyPropertyEntity>
{
    ...
    public async Task<SRealityAdvertDto> CreateAsync(SRealtyPropertyEntity entity, CancellationToken cancellationToken = default)
    {
    ...
    public Task<SRealityAdvertDto?> UpdateAsync(Guid id, SRealtyPropertyEntity entity, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public async Task<SRealityAdvertDto> CreateFromDtoAsync(SRealityAdvertDto dto, CancellationToken cancellationToken = default)
    {
