...
/// <summary>
/// Mapperly mapping between the DTO and the entity. Unmapped target properties fail the build; a null in a
/// required field throws, so only a validated DTO may be passed in.
/// </summary>
[Mapper(
