...
{
    /// <summary>
    /// Validates, normalizes (JPEG, bounded size, metadata stripped) and writes an image, returning the path it can be read back by.
    ...
    /// <summary>Removes every image of an advert in one go.</summary>
