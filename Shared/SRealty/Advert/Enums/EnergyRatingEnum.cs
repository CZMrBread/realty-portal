...
/// <summary>Energy performance class, from A for the most efficient buildings to G for the least.</summary>
public enum EnergyRatingEnum
{
    [LocalizedDisplayName(DisplayNameCz = "A", DisplayNameEn = "A",
    ...
    [LocalizedDisplayName(DisplayNameCz = "B", DisplayNameEn = "B", DescriptionCz = "Úsporná - velmi dobrá energetická třída",
        DescriptionEn = "Efficient - very good energy class", Icon = "bi-battery-half")]
    B = 2,

    [LocalizedDisplayName(DisplayNameCz = "C", DisplayNameEn = "C", DescriptionCz = "Vyhovující - dobrá energetická třída",
        DescriptionEn = "Adequate - good energy class", Icon = "bi-battery")]
    C = 3,

    [LocalizedDisplayName(DisplayNameCz = "D", DisplayNameEn = "D", DescriptionCz = "Méně úsporná - průměrná energetická třída",
        DescriptionEn = "Less efficient - average energy class", Icon = "bi-speedometer")]
    D = 4,

    [LocalizedDisplayName(DisplayNameCz = "E", DisplayNameEn = "E", DescriptionCz = "Nehospodárná - horší energetická třída",
        DescriptionEn = "Inefficient - worse energy class", Icon = "bi-exclamation-triangle")]
    E = 5,

    [LocalizedDisplayName(DisplayNameCz = "F", DisplayNameEn = "F",
    ...
    [LocalizedDisplayName(DisplayNameCz = "G", DisplayNameEn = "G",
