...
public sealed partial record SrealityAdvertDto
{
    ...
    /// <summary>Date of the second viewing, when the auctioneer arranges more than one.</summary>
    [JsonPropertyName("auction_date_tour2")]
    public DateTimeOffset? AuctionDateTour2 { get; set; }

    /// <summary>Lowest bid the auction starts from. Required for auctions where the price moves upwards.</summary>
    ...
    /// <summary>Value of the property according to the expert valuation report, required for involuntary and enforcement auctions.</summary>
    [Range(0, double.MaxValue)]
    [RequiredIfValue(nameof(AdvertFunction), [AdvertFunctionEnum.Auction])]
    ...
    /// <summary>Security a bidder has to lodge in order to take part in the auction.</summary>
    [Range(0, double.MaxValue)]
